  ...
  return (
    <div className="relative w-72 bg-slate-900/50 border-r border-slate-800 p-4 flex flex-col flex-shrink-0">
      ...
      <nav className="flex-1 space-y-2">
            ...
            <AccordionItem title="Work on Articles" icon={<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13c-1.168.777-2.754 1.253-4.5 1.253s-3.332-.477-4.5-1.253"></path></svg>} isOpen={openMenu === 'articles'} onToggle={() => handleMenuToggle('articles')}>
                ...
                <NavItem 
                    ...
                    viewName="recycle-article" 
                    currentView={view} 
                    onClick={() => handleNavClick('recycle-article')}
                >
                ...
                {hasGeneratedArticle && (
                    <NavItem 
                        ...
                        viewName="refine-article" 
                        currentView={view} 
                        onClick={() => handleNavClick('refine-article')}
                    >
                ...
                <NavItem label="Article Templates" viewName="article-templates" currentView={view} onClick={() => handleNavClick('article-templates')} badge={articleTemplateCount}><svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16M4 18h7"></path></svg></NavItem>
            </AccordionItem>

            <AccordionItem title="Work on Podcasts" icon={<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z"></path></svg>} isOpen={openMenu === 'podcast'} onToggle={() => handleMenuToggle('podcast')}>
                 <NavItem label="Generate Podcast Plan" viewName="generate-podcast" currentView={view} onClick={() => handleNavClick('generate-podcast')}>
            ...
            <AccordionItem title="Work on Audio" icon={<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z"></path></svg>} isOpen={openMenu === 'audio'} onToggle={() => handleMenuToggle('audio')}>
                 <NavItem label="Generate Audio Script" viewName="generate-audio-script" currentView={view} onClick={() => handleNavClick('generate-audio-script')}>
             ...
             <AccordionItem title="Admin" icon={<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>} isOpen={openMenu === 'admin'} onToggle={() => handleMenuToggle('admin')}>
                ...
                <NavItem label="Settings" viewName="settings" currentView={view} onClick={() => handleNavClick('settings')}><svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path></svg></NavItem>
             ...
             <AccordionItem title="Guides" icon={<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13c-1.168.777-2.754 1.253-4.5 1.253s-3.332-.477-4.5-1.253"></path></svg>} isOpen={openMenu === 'guides'} onToggle={() => handleMenuToggle('guides')}>
                <NavItem label="New User Guide" viewName="new-user-guide" currentView={view} onClick={() => handleNavClick('new-user-guide')}><svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg></NavItem>
                <NavItem label="Posting Guides" viewName="posting-guides" currentView={view} onClick={() => handleNavClick('posting-guides')}><svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13c-1.168.777-2.754 1.253-4.5 1.253s-3.332-.477-4.5-1.253"></path></svg></NavItem>
             </AccordionItem>
      </nav>
      ...
      <div className="mt-auto pt-6">
        <button
          onClick={onSignOut}
          className="w-full flex items-center p-2 rounded-md text-sm text-red-400 hover:bg-red-500/20 hover:text-red-300"
        >
