    ...
    <div className="w-72 bg-slate-900/50 border-r border-slate-800 p-4 flex flex-col flex-shrink-0">
      <div className="flex-grow">
        ...
        <nav className="flex flex-col space-y-1">
          ...
          <NavItem label="Planned Posts" viewName="planned-posts" currentView={view} setView={setView}>
          ...
          <NavItem label="Scheduler" viewName="scheduler" currentView={view} setView={setView}>
             <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 14l-3 3m0 0l3 3m-3-3h6" /></svg>
          </NavItem>
      ...
      <div className="flex-shrink-0 pt-4 border-t border-slate-800 space-y-1">
        <NavItem label="Stored Page Data" viewName="stored-data" currentView={view} setView={setView}>
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7v8a2 2 0 002 2h4a2 2 0 002-2V7a2 2 0 00-2-2h-4a2 2 0 00-2 2z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V7"></path></svg>
        </NavItem>
        <button
